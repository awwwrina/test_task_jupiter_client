    ...
    return(
        <>
            <svg xmlns="http://www.w3.org/2000/svg" width="45.651" height="43.416" viewBox="0 0 45.651 43.416">
                <g id="poli" data-name="poli" transform="translate(-1.175)">
                    ...
                    <path id="Polygon-2" data-name="Polygon" d="M9.5,0l9.035,6.564L15.084,17.186H3.916L.465,6.564Z" transform="translate(14.5 14.115)" fill="#ef6d58"/>
                </g>
            </svg>
        </>
    )
